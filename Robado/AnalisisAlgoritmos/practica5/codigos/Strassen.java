...
public class Strassen
{
	...
	public void imprimirMat(int[][] a, int n)
	{
		for(int i=0;i<n;++i)
		{
			for(int j=0;j<n;++j)
	...
	public int[][] MMC(int[][] a,int[][] b, int n)
	{
		int[][] c = new int[n][n];
		if(n==2)
			c = multiplica(a,b);
		else
		{
			...
			int[][] s1 = MMC(resta(A12,A22,n/2),suma(B21,B22,n/2),n/2);
			int[][] s2 = MMC(suma(A11,A22,n/2),suma(B11,B22,n/2),n/2);
			int[][] s3 = MMC(resta(A11,A21,n/2),suma(B11,B12,n/2),n/2);

			int[][] s4 = MMC(suma(A11,A12,n/2),B22,n/2);
			int[][] s5 = MMC(A11,resta(B12,B22,n/2),n/2);
			int[][] s6 = MMC(A22,resta(B21,B11,n/2),n/2);
			int[][] s7 = MMC(suma(A21,A22,n/2),B11,n/2);
	...
	public static void main(String[] args)
	{
		...
		for(int p=2;p<=256;p*=2)
		{
			...
			int[][] c = s.MMC(a,b,p);
			//s.imprimirMat(c,p);
			System.out.printf("La funcion MMC con n= %d realiza %d pasos\n",p,s.contador);
		}
